...
<!-- Image: generated by `npm run screenshots` → screenshots/04-detectors.png.
     Upload it to GitHub and replace the src below with the user-attachments URL, matching the images above. -->
