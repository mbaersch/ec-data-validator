...
- **Clear links** next to the EM Decoder and Object Analysis textareas — disabled when the field is empty, syncs with text pasted from the storage on side-panel open.
