...
- **Settings tab** (⚙ icon, top right): central place for capture filters, permit behaviour, and the toolbar indicator — each option shown with a full description, not just a tooltip
